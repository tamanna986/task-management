...
const Footer = () => {
    return (
        ...
        <footer className="footer p-10 pt-10 md:pt-32 h-80 pl-20 md:pl-10 bg-green-950 text-orange-300">
            <aside>

                <h1 className="text-lg font-bold  inline-block text">SCC Technovision Inc.</h1>
                <p>Copyright © 2023 - All right reserved by SCC Technovision Inc.</p>
            </aside>

            <nav>
                <header className="footer-title text-center ml-20 ">Company</header>
            ...
            <nav>
            <header className="footer-title text-center  -mt-3  pl-16 md:pl-0">Company</header>   
